...
/** Problem 1: Write a javascript function named is_integer which checks if 
 * the passed argument is an integer. You can use any mathematical operator
 * or functions defined in the Math object.  **/
function is_integer(n) {
  return typeof(n) == "number" && Math.floor(n) == n;
}

/** Problem 2: Using the forEach function defined for an array, find the 
 * sum of the array of numbers. [function add_all(arr) {...}] **/
...
/** Problem 3: Write a JavaScript program to convert temperatures to and from 
 * celsius, fahrenheit. [ Use the formula : c/5 = (f-32)/9, where c = temperature 
...
/** Problem 4: Write a factorial function that returns the factorial of a given 
 * number, n. Make sure you return the calculated value and not just print it. 
...
/** Problem 5: Write a javascript function that converts a given amount of money into 
